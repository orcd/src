...
QT_MOC_LITERAL(3, 22, 3)
    ...
    "WebServer\0newMessage\0\0msg\0"
};
...
void WebServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WebServer::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WebServer::newMessage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void WebServer::newMessage(QByteArray _t1)
{
