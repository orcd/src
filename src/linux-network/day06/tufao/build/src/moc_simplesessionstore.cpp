...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tufao__SimpleSessionStore_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "Tufao::SimpleSessionStore\0onTimer\0\0"
};
...
const QMetaObject Tufao::SimpleSessionStore::staticMetaObject = {
    { &SessionStore::staticMetaObject, qt_meta_stringdata_Tufao__SimpleSessionStore.data,
      qt_meta_data_Tufao__SimpleSessionStore,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__SimpleSessionStore.stringdata))
