...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tufao__HttpsServer_t, stringdata) + ofs \
...
const QMetaObject Tufao::HttpsServer::staticMetaObject = {
    { &HttpServer::staticMetaObject, qt_meta_stringdata_Tufao__HttpsServer.data,
      qt_meta_data_Tufao__HttpsServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__HttpsServer.stringdata))
