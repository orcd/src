...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tufao__ClassHandlerManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 98, 12)
    ...
    "HttpServerResponse&\0response\0urlNamespace\0"
};
...
const QMetaObject Tufao::ClassHandlerManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tufao__ClassHandlerManager.data,
      qt_meta_data_Tufao__ClassHandlerManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__ClassHandlerManager.stringdata))
        return static_cast<void*>(const_cast< ClassHandlerManager*>(this));
    if (!strcmp(_clname, "AbstractHttpServerRequestHandler"))
        return static_cast< AbstractHttpServerRequestHandler*>(const_cast< ClassHandlerManager*>(this));
...
int Tufao::ClassHandlerManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = urlNamespace(); break;
        }
        _id -= 1;
