...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tufao__HttpServerRequestRouter_t, stringdata) + ofs \
...
const QMetaObject Tufao::HttpServerRequestRouter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tufao__HttpServerRequestRouter.data,
      qt_meta_data_Tufao__HttpServerRequestRouter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__HttpServerRequestRouter.stringdata))
        return static_cast<void*>(const_cast< HttpServerRequestRouter*>(this));
    if (!strcmp(_clname, "AbstractHttpServerRequestHandler"))
        return static_cast< AbstractHttpServerRequestHandler*>(const_cast< HttpServerRequestRouter*>(this));
