...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tufao__ClassHandler_t, stringdata) + ofs \
...
const QMetaObject Tufao::ClassHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tufao__ClassHandler.data,
      qt_meta_data_Tufao__ClassHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__ClassHandler.stringdata))
        return static_cast<void*>(const_cast< ClassHandler*>(this));
